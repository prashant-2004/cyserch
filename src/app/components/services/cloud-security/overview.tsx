export default function CloudSecurityOverview() {
  return (
    <div className="text-center px-[9rem] py-[3rem]">
      <h1 className="text-white text-[2.18rem] font-semibold mt-3">Overview : Cyber Defense Resiliency Service</h1>
      <h3 className="text-gray-400 font-bold text-[1.18rem] mt-3">Next-Gen Cybersecurity Solutions: Empowering Cyber Defense Resiliency</h3>
      ...
      <p className="text-[#A39D9D] text-[1.2rem] font-light mt-4">At Cyserch, we follow a customer-centric approach to create cybersecurity solutions that help our clients build resilient enterprises. We offer platform-based enterprise cybersecurity solutions, which are proactive, prescriptive, and cognitively autonomous.
      </p>
      <p className="text-[#A39D9D] text-[1.2rem] font-light mt-4">
